...
local descs = {}
	...
	settings.Admins = {"ilovecats5th","shadowpriestokpts","lolthib1411","Shadow_Operator1"}  		-- Admins; 						              Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}
	settings.Owners = {"oriax908","MinecraftHDMATRO_2nd"}       	-- Head Admins;								  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}
	settings.Creators = {"USM_Backup","ItsAlec18","starwars_empire1254","Themeowingcatfish1","8bitcoolcloudy"}      -- Place Owner;								  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID";}
	...
	settings.BanMessage = "You are blacklisted from our game"				-- Message shown to banned users
	settings.LockMessage = "You are not allowed to join the server"	-- Message shown to people when they are kicked while the game is :slocked
	settings.SystemTitle = "United States Military Announcement"		-- Title to display in :sm 
	
	settings.MaxLogs = 200			-- Maximum logs to save before deleting the oldest; Too high can lag the game
