...
ContextActionService:BindActionAtPriority("BaseCameraKeyboardPan", onKeyPress, false, Priority,
	Enum.KeyCode.Comma, Enum.KeyCode.Period, Enum.KeyCode.PageUp, Enum.KeyCode.PageDown)