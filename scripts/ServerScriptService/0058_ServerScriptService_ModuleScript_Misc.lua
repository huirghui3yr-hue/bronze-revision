...
do -- system shouts
	spawn(function()
		local shouts = {
			...
			'If you find a bug in the game, please take a screenshot and tweet it to @lando64000 with an explanation of what\'s wrong.',
		}
			...
			for i = 1, 6 do
				if balls[i] then
					...
					if n and n > 0 then
						...
						if location then
							local ballname = ({'pokeball','greatball','ultraball','masterball','safariball','levelball','lureball','moonball','friendball','loveball','heavyball','fastball','sportball','premierball','repeatball','timerball','nestball','netball','diveball','luxuryball','healball','quickball','duskball','cherishball','parkball','dreamball'})[n]
							local ballModel = (repStorage.Models.Pokeballs:FindFirstChild(ballname) or repStorage.Models.pokeball):Clone()
