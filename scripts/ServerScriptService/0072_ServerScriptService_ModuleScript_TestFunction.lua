...
--	_p.PVP:onClickedPlayer()
	...
	local imageId1 = 'http://www.roblox.com/Thumbs/Avatar.ashx?x=420&y=420&Format=Png&userid=1084073'
	local imageId2 = 'http://www.roblox.com/Thumbs/Avatar.ashx?x=420&y=420&Format=Png&userid=1123551'
	_p.Battle:doVsAnimation({'tbradm', 'lando64000'}, {imageId1, imageId2})
...
--		trainerModel = game.ReplicatedStorage.Models.NPCs.Dad,
--		num = 121,
--	}
...
--		trainerModel = game.ReplicatedStorage.Models.NPCs.Jake,
