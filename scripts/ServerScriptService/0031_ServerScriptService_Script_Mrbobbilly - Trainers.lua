...
--					{ id = 'calmmind' },{ id = 'dazzlinggleam' },
		...
		{ -- [#161] : 7th Gym - Adventurer
			...
			Party = {
				...
				{ name = 'Sableye', item = 'sablenite', level = 83},
			},
			onWin = function(PlayerData)
		...
		{ -- [#174] : Eclipse Base - Grunt
			...
			Party = {
				{ name = 'Greninja', level = 79},
				{ name = 'Decidueye', level = 79},
				{ name = 'Incineroar', level = 79},
				{ name = 'Empoleon', level = 79},
				{ name = 'Sceptile', level = 79},				
				{ name = 'Charizard', item = 'charizarditex', level = 80},
			},
			onWin = function(PlayerData)
				if not PlayerData.flags.winBattle152 then return end
				--PlayerData:completeEventServer('TERt14')
		...
		--right here add 185 adventurer tanner
