...
719,diancie,6,4,3,70,25,1,,Guardian,"It confuses its enemies by flying too quickly for the eye to follow. It has a hair-trigger temper but forgets what made it angry an instant later."
...
735,gumshoos,3,8,127,70,15,2,,Stakeout,"When it finds a trace of its prey, it patiently stakes out the location but it’s always snoozing by nightfall."
736,grubbin,4,14,255,70,15,2,376,Larva,"If you find its nest, you shouldn’t stick your hand inside. You’ll get bitten by an irritated Grubbin."
...
738,vikavolt,2,14,45,70,15,2,,"	It builds up electricity in its abdomen, focuses it through its jaws, and then fires the electricity off in concentrated beams."
...
742,cutiefly,10,14,190,70,20,2,379,Bee Fly,"It feeds on the nectar and pollen of flowers. Because it’s able to sense auras, it can identify which flowers are about to bloom."
...
744,rockruff,3,8,190,70,15,2,380,Puppy,"When it rubs the rocks on its neck against you, that’s proof of its love for you. However, the rocks are sharp, so the gesture is quite painful!"
...
746,wishiwashi,2,3,60,70,15,1,381,Small Fry,"When it’s in trouble, its eyes moisten and begin to shine. The shining light attracts its comrades, and they stand together against their enemies."
747,mareanie,2,5,190,70,20,2,382,Brutal Star,"Aside from its head, its body parts regenerate quickly if they’re cut off. After a good night’s sleep, Mareanie is back to normal."
748,toxapex,2,10,75,70,20,2,,Brutal Star,"With its 12 legs, it creates a dome to shelter within. The flow of the tides doesn’t affect Toxapex in there, so it’s very comfortable."
...
756,shiinotic,7,12,75,70,20,2,,"It puts its prey to sleep and siphons off their vitality through the tip of its arms. If one of its kind is weakened, it helps by sending it vitality."
757,salandit,1,8,120,70,20,2,387,"It burns its bodily fluids to create a poisonous gas. When its enemies become disoriented from inhaling the gas, it attacks them."
758,salazzle,1,8,45,70,20,2,,"Filled with pheromones, its poisonous gas can be diluted to use in the production of luscious perfumes."
759,stufful,6,8,140,70,15,2,388,"Despite its adorable appearance, when it gets angry and flails about, its arms and legs could knock a pro wrestler sprawling."
760,bewear,6,6,70,70,15,2,,"It waves its hands wildly in intimidation and warning. Life is over for anyone who doesn’t run away as fast as possible."
761,bounsweet,7,7,235,70,20,3,389,"When under attack, it secretes a sweet and delicious sweat. The scent only calls more enemies to it."
762,steenee,7,12,120,70,20,3,,"It bounces around, swinging the sepals on its head with abandon. They’re quite painful when they smack you!"
763,tsareena,7,12,45,70,20,3,,"Its long, striking legs aren’t just for show but to be used to kick with skill. In victory, it shows off by kicking the defeated, laughing boisterously."
764,comfey,5,1,60,70,20,1,390,"It attaches flowers to its highly nutritious vine. This revitalizes the flowers, and they give off an aromatic scent."
765,oranguru,9,12,45,70,20,4,391,"It don’t get along with each other, so they’re always engaging in battles of wits to decide which one is superior."
766,passimian,9,6,45,70,20,4,392,"They use their saliva to stick leaves to their shoulders. You can tell what troop they belong to from the position of the leaves."
767,wimpod,4,10,90,70,20,2,393,"Its habitat varies from beaches to seabeds. A natural scavenger, it will gleefully chow down on anything edible, no matter how rotten."
768,golisopod,4,12,45,70,20,2,,"It will do anything to win, taking advantage of every opening and finishing opponents off with the small claws on its front legs."
769,sandygast,3,2,140,70,15,2,394,"Born from a sand mound playfully built by a child, this Pokémon embodies the grudges of the departed."
770,palossand,3,2,60,70,15,2,,"Buried beneath the castle are masses of dried-up bones from those whose vitality it has drained."
771,pyukumuku,1,2,60,70,15,1,395,"Its entire body is covered in its own slime. If you accidentally step on one, you’ll slip, and it will get mad and smack you!"
772,typenull,4,8,3,0,120,4,396,"There’s danger of its going on a rampage, so its true power is sealed away beneath its control mask."
773,silvally,4,8,3,0,120,4,,"This is its form once it has awakened and evolved. Freed from its heavy mask, its speed is greatly increased."
774,minior,3,1,30,70,25,3,397,"Although its outer shell is uncommonly durable, the shock of falling to the ground smashes the shell to smithereens."
775,komala,2,12,45,70,20,4,398,"It stays asleep from the moment it’s born. When it falls into a deep sleep, it stops moving altogether."
776,turtonator,8,6,70,70,20,2,399,"Eating sulfur in its volcanic habitat is what causes explosive compounds to develop in its shell. Its droppings are also dangerously explosive."
777,togedemaru,4,6,180,70,10,2,400,"Its capacity to produce electricity is somewhat limited, so it gets charged up by letting lightning strike it!"
778,mimikyu,10,2,45,70,20,2,401,"Its actual appearance is unknown. A scholar who saw what was under its rag was overwhelmed by terror and died from the shock."
779,bruxish,6,3,80,70,15,2,402,"When it unleashes its psychic power from the protuberance on its head, the grating sound of grinding teeth echoes through the area."
780,drampa,9,2,70,70,20,2,403,"It has a compassionate personality, but if it is angered, it completely Removes its surroundings with its intense breath."
781,dhelmise,5,5,25,70,25,2,404,"Swinging its massive anchor, it can KO Wailord in a single blow. What appears to be green seaweed is actually its body."
782,jangmoo,4,8,45,70,40,4,405,"It smacks the scales on its head against rocks or against the ground to frighten its opponents. It can also contact its friends with these noises."
783,hakamoo,4,6,45,70,40,4,,"It leaps at its prey with a courageous shout. Its scaly punches tear its opponents to shreds."
784,kommoo,4,6,45,70,40,4,,"When it spots enemies, it threatens them by jingling the scales on its tail. Weak opponents will crack and flee in panic."
785,tapukoko,10,4,3,70,15,4,406,"It confuses its enemies by flying too quickly for the eye to follow. It has a hair-trigger temper but forgets what made it angry an instant later."
786,tapulele,6,4,3,70,15,4,407,"As it flutters about, it scatters its strangely glowing scales. Touching them is said to restore good health on the spot."
787,tapubulu,8,4,3,70,15,4,408,"It pulls large trees up by the roots and swings them around. It causes vegetation to grow, and then it absorbs energy from the growth."
788,tapufini,7,4,3,70,15,4,409,"The dense fog it creates brings the downfall and destruction of its confused enemies. Ocean currents are the source of its energy."
789,cosmog,2,1,45,0,120,4,410,"Its body is gaseous and frail. It slowly grows as it collects dust from the atmosphere."
790,cosmoem,2,1,45,0,120,4,,"Motionless as if dead, its body is faintly warm to the touch. In the distant past, it was called the cocoon of the stars."
791,solgaleo,9,8,45,0,120,4,,"It is said to live in another world. The intense light it radiates from the surface of its body can make the darkest of nights light up like midday."
792,lunala,7,9,45,0,120,4,,"It sometimes summons unknown powers and life-forms here to this world from holes that lead to other worlds."
793,nihilego,9,10,45,0,120,4,411,"One of several mysterious Ultra Beasts. People on the street report observing those infested by it suddenly becoming violent."
794,buzzwole,8,10,45,0,120,4,412,"A mysterious life-form called an Ultra Beast. Witnesses saw it pulverize a dump truck with a single punch."
795,pheromosa,9,12,45,0,120,4,413,"A life-form that lives in another world, its body is thin and supple, but it also possesses great power."
796,xurkitree,1,6,45,0,120,4,414,"Although it’s alien to this world and a danger here, it’s apparently a common organism in the world where it normally lives."
797,celesteela,5,12,45,0,120,4,415,"One of the dangerous UBs, high energy readings can be detected coming from both of its huge arms."
798,kartana,9,12,45,0,120,4,416,"Although it’s alien to this world and a danger here, it’s apparently a common organism in the world where it normally lives."
799,guzzlord,1,6,45,0,120,4,417,"Although it’s alien to this world and a danger here, it’s apparently a common organism in the world where it normally lives."
800,necrozma,1,4,255,0,120,4,418,"Light is apparently the source of its energy. It has an extraordinarily vicious disposition and is constantly firing off laser beams."
801,magearna,4,12,3,0,120,4,419,"It synchronizes its consciousness with others to understand their feelings. This faculty makes it useful for taking care of people."
802,marshadow,4,12,3,0,120,4,420,"It sinks into the shadows of people and Pokémon, where it can understand their feelings and copy their capabilities."
803,poipole,2,3,60,70,20,1,,Ultra Beast,This Ultra Beast is well enough liked to be chosen as a first partner in its own world.
804,naganadel,2,3,30,70,20,1,,Ultra Beast,It stores hundreds of liters of poisonous liquid inside its body. It is one of the organisms known as UBs.
805,stakataka,2,6,255,70,20,2,300,Rampart,"When stone walls started moving and attacking, the brute's true identity was this mysterious life-form, which brings to mind an Ultra Beast. "
806,blacephalon,3,12,90,70,20,2,,Exploding Head Syndrome,"It slithers toward people. Then, without warning, it triggers the explosion of its own head. It's apparently one kind of Ultra Beast."
807,zeraora,9,5,190,70,20,4,301,ThunderClap,"It electrifies its claws and tears its opponents apart with them. Even if they dodge its attack, they'll be electrocuted by the flying sparks. "
810,grookey,1,12,45,70,20,4,427,Chimp,"When it uses its special stick to strike up a beat, the sound waves produced carry revitalizing energy to the plants and flowers in the area."
811,thwackey,1,12,45,70,20,4,427,Beat,"The faster a Thwackey can beat out a rhythm with its two sticks, the more respect it wins from its peers."
812,rillaboom,1,12,45,70,20,4,427,Drummer,"By drumming, it taps into the power of its special tree stump. The roots of the stump follow its direction in battle."
813,scorbunny,1,12,45,70,20,4,427,Rabbit,"A warm-up of running around gets fire energy coursing through this Pokémon’s body. Once that happens, it’s ready to fight at full power."
814,raboot,1,12,45,70,20,4,427,Rabbit,"It's thick and fluffy fur protects it from the cold and enables it to use hotter fire moves."
815,cinderace,1,12,45,70,20,4,427,Striker,"It juggles a pebble with its feet, turning it into a burning soccer ball. Its shots strike opponents hard and leave them scorched."
816,sobble,1,12,45,70,20,4,427,Water Lizard,"When scared, this Pokemon cries. Its tears pack the chemical punch of 100 onions, and attackers won’t be able to resist weeping."
817,drizzile,1,12,45,70,20,4,427,Water Lizard,"A clever combatant, this Pokemon battles using water balloons created with moisture secreted from its palms."
818,inteleon,1,12,45,70,20,4,427,Secret Agent,"It has many hidden capabilities, such as fingertips that can shoot water and a membrane on its back that it can use to glide through the air."
819,skwovet,1,12,45,70,20,4,427,Cheeky,"Found throughout the Galar region, this Pokémon becomes uneasy if its cheeks are ever completely empty of berries."
820,greedent,1,12,45,70,20,4,427,Greedy,"Common throughout the Galar region, this Pokémon has strong teeth and can chew through the toughest of berry shells."
821,rookidee,1,12,45,70,20,4,427,Tiny Bird,"It will bravely challenge any opponent, no matter how powerful. This Pokémon benefits from every battle—even a defeat increases its strength a bit."
822,corvisquire,1,12,45,70,20,4,427,Raven,"Smart enough to use tools in battle, these Pokémon have been seen picking up rocks and flinging them or using ropes to wrap up enemies."
823,corviknight,1,12,45,70,20,4,427,Raven,"This Pokémon reigns supreme in the skies of the Galar region. The black luster of its steel body could drive terror into the heart of any foe."
824,blipbug,1,12,45,70,20,4,427,Larva,"	A constant collector of information, this Pokemon is very smart. Very strong is what it isn’t."
825,dottler,1,12,45,70,20,4,427,Radome,"It barely moves, but it’s still alive. Hiding in its shell without food or water seems to have awakened its psychic powers."
826,orbeetle,1,12,45,70,20,4,427,Seven Spot,"It’s famous for its high level of intelligence, and the large size of its brain is proof that it also possesses immense psychic power."
837,rolycoly,1,12,45,70,20,4,427,Coal,"Most of its body has the same composition as coal. Fittingly, this Pokemon was first discovered in coal mines about 400 years ago."
838,carkol,1,12,45,70,20,4,427,Coal,"It forms coal inside its body. Coal dropped by this Pokemon once helped fuel the lives of people in the Galar region."
839,coalossal,1,12,45,70,20,4,427,Coal,"It’s usually peaceful, but the vandalism of mines enrages it. Offenders will be incinerated with flames that reach 2,700 degrees Fahrenheit."
845,cramorant,1,12,3,0,120,4,427,Gulp,"It’s so strong that it can knock out some opponents in a single hit, but it also may forget what it’s battling midfight."
870,falinks,1,12,3,0,120,4,427,Formation,"Five of them are troopers, and one is the brass. The brass’s orders are absolute."
871,pincurchin,1,12,3,0,120,4,427,Sea Urchin,"	It feeds on seaweed, using its teeth to scrape it off rocks. Electric current flows from the tips of its spines."
874,stonjourner,1,12,3,0,120,4,427,Big Rock,"It stands in grasslands, watching the sun’s descent from zenith to horizon. This Pokemon has a talent for delivering dynamic kicks."
882,dracovish,1,12,45,50,120,4,427,Fossil,"Powerful legs and jaws made it the apex predator of it's time. It's own overhunting of it's prey was what drove it to extinction."
884,duraludon,1,12,45,50,120,4,427,Alloy,"Its body resembles polished metal, and it’s both lightweight and strong. The only drawback is that it rusts easily."
888,zacian,1,12,3,0,120,4,427,Warrior,"Known as a legendary hero, this Pokemon absorbs metal particles, transforming it into a weapon it uses to battle."
890,eternatus,1,12,3,0,120,4,427,Gigantic,"The core on it's chest absorbs emanating from the lands of the Galar region. This energy is what allows Eternatus to stay active."
893,regieleki,10,12,1,0,120,4,427,Electron,"This Pokemon is a cluster of electrical energy. Its said that removing the rings on Regieleki's body will unleash the Pokemon's latent power."
895,regidrago,4,12,1,0,120,4,427,Dragon Orb,"An academic theory proposes that Regidrago’s arms were once the head of an ancient dragon Pokémon. The theory remains unproven."]])