...
local function getData(kind, id)
	...
	if ({unboost=true,nopp=true,recoil=true,psn=true,brn=true,protect=true,stockpile1=true,stockpile2=true,stockpile3=true,perish3=true,perish2=true,perish1=true,perish0=true})[id] then
