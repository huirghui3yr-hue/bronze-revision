...
--============================================================================================================
	...
	['blueorb'] = {
		...
		onSwitchIn = function(pokemon)
			if pokemon.isActive and pokemon.baseTemplate.species == 'Kyogre' then
				...
				self:add('detailschange', pokemon, pokemon.details)
				self:add('message', pokemon.name .. "'s Primal Reversion! It reverted to its primal form!")
				pokemon:setAbility(template.abilities[1])
				pokemon.baseAbility = pokemon.ability
			end
		end,
		onTakeItem = function(item, source)
			if source.baseTemplate.baseSpecies == 'Kyogre' then return false end
			return true
		end,
	},
	['blukberry'] = {
	...
	['lightball'] = {
		...
		onModifyAtk = function(atk, pokemon)
			if pokemon.baseTemplate.baseSpecies == 'Pikachu' then
				return self:chainModify(2)
			end
		end,
		onModifySpAPriority = 1,
	...
	['redorb'] = {
		...
		onSwitchInPriority = -6,
		onSwitchIn = function(pokemon)
			if pokemon.isActive and pokemon.baseTemplate.species == 'Groudon' then
		...
		onTakeItem = function(item, source)
			if source.baseTemplate.baseSpecies == 'Groudon' then return false end
			return true
		end,
	},
	['repeatball'] = {
