	...
	while #chatQueue > 0 do
		...
		repeat
			...
			overflow = write(str) {
				...
				AnimationRate = (_p.Menu and _p.Menu.options and _p.Menu.options.dialogSpeed) or 35, -- ht / sec; controlled by Options menu
			}
